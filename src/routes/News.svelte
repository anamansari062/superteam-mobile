...
<section class="sm:w-full min-h-screen sm:pt-24 pb-24 gap-16 sm:mx-auto lg:px-20">
	<div class="flex flex-col gap-8 sm:mx-auto">
		...
		<div class="flex flex-col md:flex-row sm:w-full gap-8 sm:mx-auto">
			<a href="/projects" class="bigCard bg-[url('./lib/images/mobile_projects.png')] flex flex-col justify-end sm:w-full h-96 border border-white/20 rounded-xl bg-no-repeat sm:bg-cover bg-center bg-clip-padding">
				<div class="bigCard">
