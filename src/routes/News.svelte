...
<section class="sm:w-full pb-36 xl:pb-48 sm:pt-24 gap-16 sm:mx-auto lg:px-20">
	<div class="flex flex-col gap-8 sm:mx-auto">
		...
		<div class="flex flex-col md:flex-row sm:w-full gap-8 sm:mx-auto">
			<a href="/projects" class="bigCard bg-[url('./lib/images/active_projects.png')] flex flex-col justify-end sm:w-full h-96 border border-white/20 rounded-xl bg-no-repeat sm:bg-cover bg-center bg-clip-padding">
				<div class="bigCard">
					<div class="cardContent p-3 rounded-b-xl bg-black/20 backdrop-blur-sm sm:backdrop-blur-md">
						...
						<h3 class="text-base font-normal leading-6 text-left text-gray-300">Mobile Projects killing it in the ecosystem</h3>
					</div>
				</div>
			</a>
